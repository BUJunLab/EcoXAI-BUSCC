...
// Export the execution backend for the active runtime. On a cluster with no
// Docker daemon, agents run as Singularity child processes instead.
const runtimeConfig = require('./runtimeConfig');

module.exports = runtimeConfig.IS_SINGULARITY
  ? require('./singularityManager')
  : new ContainerManager();
module.exports.ContainerManager = ContainerManager;
